...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"dashboard.js":[function(require,module,exports) {
"use strict";
...
var new_invoice = document.getElementById('new-invoice');
var new_cust = document.getElementById('new-customer');
var customer_list = document.getElementById('customer-list');
var paid_invoices = document.getElementById('paid-invoices');

var getColor = function getColor(date_paid, status) {
  if (date_paid) return 'Blue';else if (status === 'Active') return 'green';else if (status === 'Not Active') return 'red';
};

if (home) {
  home.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var res, html, ids;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            html = "<h2>Invoices</h2>";
            ids = [];
            res.data.data.doc.forEach(function (el, i) {
              html += "\n            <div class=\"row invoice-item\" id=\"item-".concat(el.number, "\">\n                <div class=\"col span-1-of-4\"> ").concat(el.customer.name, "</div>\n                <div class=\"col span-1-of-4\"> ").concat(el.reason ? el.reason : 'No reason provided', " </div>\n                <div class=\"col span-1-of-4\"> $").concat(el.balance_due, " </div>\n                <div class=\"col span-1-of-4\"> <span style=\"color:").concat(getColor(el.date_paid, el.status), "\";>").concat(el.date_paid ? 'Paid' : el.status, "</span> </div>\n            </div>");
              ids.push("item-".concat(el.number));
            });
            document.querySelector('.viewing-box').innerHTML = html;
            ids.forEach(function (el) {
              var num = el.split('-')[1];
              document.querySelector("#".concat(el)).addEventListener('click', function () {
                window.setTimeout(function () {
                  location.assign("/invoice-details/".concat(num, "/"));
                }, 1500);
              });
            });
...
if (new_invoice) {
  new_invoice.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var cust_names, allCustomers, newItem, wholeHTML, invoice_form;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            allCustomers.data.data.doc.forEach(function (el) {
              cust_names += "<option value=\"".concat(el.name, "\">").concat(el.name, "</option>");
            });
            ...
            invoice_form = document.getElementById('invoice-form');
            invoice_form.addEventListener('submit', /*#__PURE__*/function () {
              var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
                var values, _values, customer, due_date, reason, items, formatted_items, balance_due, i, _ref4, description, amount, quantity, res;
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        e.preventDefault();
                        values = Array.from(invoice_form.elements).map(function (el) {
                          return el.value;
                        });
                        values.pop();
                        values.pop();
                        _values = _toArray(values), customer = _values[0], due_date = _values[1], reason = _values[2], items = _values.slice(3);
                        formatted_items = [];
                        balance_due = 0;

                        for (i = 0; i < items.length; i += 3) {
                          _ref4 = [items[i], parseFloat(items[i + 1]), parseFloat(items[i + 2])], description = _ref4[0], amount = _ref4[1], quantity = _ref4[2];
                      ...
                      case 11:
                        ...
                        ['description', 'amount', 'quantity', 'date'].forEach(function (element) {
                          Array.from(document.getElementsByName(element)).forEach(function (el) {
                            return el.value = '';
                          });
                        });
                        document.querySelector('.viewing-box').innerHTML = wholeHTML;
...
if (new_cust) {
  new_cust.addEventListener('click', function () {
    ...
    customer_form.addEventListener('submit', /*#__PURE__*/function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
        var values, _values2, name, email, street_address, city, state, country, zipcode, res;
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                e.preventDefault();
                values = Array.from(customer_form.elements).map(function (el) {
                  return el.value;
                });
                values.pop();
                _values2 = _slicedToArray(values, 7), name = _values2[0], email = _values2[1], street_address = _values2[2], city = _values2[3], state = _values2[4], country = _values2[5], zipcode = _values2[6];
                _context4.next = 6;
                return (0, _axios.default)({
                  method: 'POST',
                  url: 'api/v1/customers',
              ...
              case 6:
                res = _context4.sent;
                ['name', 'mail', 'address', 'city', 'state', 'country', 'zip'].forEach(function (element) {
                  Array.from(document.getElementsByName(element)).forEach(function (el) {
                    return el.value = '';
                  });
                });
...
if (customer_list) {
  customer_list.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
    var allCustomers, html;
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            allCustomers = _context5.sent;
            html = "<h2>Customer List</h2>";
            allCustomers.data.data.doc.forEach(function (el, i) {
              html += "<div class=\"row customer-item item-".concat(i, "\">").concat(el.name, "</div>");
            });
            document.querySelector('.viewing-box').innerHTML = html;
...
if (paid_invoices) {
  paid_invoices.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
    var res, html;
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            res = _context6.sent;
            html = '<h2>Paid Invoices</h2>';
            res.data.data.doc.forEach(function (el, i) {
              if (el.date_paid < new Date().toISOString()) {
                html += "\n                <div class=\"row paid-item item-".concat(el.number, "\">\n                    <div class=\"col span-1-of-4\"> ").concat(el.customer.name, "</div>\n                    <div class=\"col span-1-of-4\"> ").concat(el.reason, " </div>\n                    <div class=\"col span-1-of-4\"> $").concat(el.balance_due, " </div>\n                    <div class=\"col span-1-of-4\"> <span style=\"color:blue\";>Paid</span></div>\n                </div>");
              }
...
var invoice_check = document.getElementById('check-invoice');
...
if (invoice_check) {
  invoice_check.addEventListener('submit', function (e) {
    e.preventDefault();
    var num = document.getElementById('invoice-num').value;
    window.setTimeout(function () {
      location.assign("/invoice-details/".concat(num, "/"));
